...
class Solution {
    public int[] colorTheArray(int n, int[][] queries) {
        ...
        int adjCount = 0;  // number of adjacent equal pairs
        ...
        for (int q = 0; q < queries.length; q++) {
            ...
            // If no change, adjacency count remains same
            ...
            if (oldColor != 0) {
                if (i > 0 && colors[i - 1] == oldColor) adjCount--;
                if (i < n - 1 && colors[i + 1] == oldColor) adjCount--;
            }
            ...
            if (newColor != 0) {
                if (i > 0 && colors[i - 1] == newColor) adjCount++;
                if (i < n - 1 && colors[i + 1] == newColor) adjCount++;
            }
